...
ALLOWED_HOSTS = ['shalala-e2sm.onrender.com', 'localhost', '127.0.0.1:8000', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = ['https://shalala-e2sm.onrender.com', 'soilution.onrender.com', 'http://localhost:8000']
